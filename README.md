...
1. Open the "User Prompt Optimizer" settings page and fill in the provider's Base URL / API Key / Model (you can click "Fetch models" to pull the list); adjust reasoning effort, sampling parameters, and max tokens as needed
