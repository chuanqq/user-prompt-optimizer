...
Following the standards and methods in <reference_template>, optimize <original_prompt>. Output only the refined prompt itself.`;
...
export const LITE_USER_TEMPLATE = `<original_prompt>
{{selection}}
</original_prompt>

Lightly polish <original_prompt> (remove ambiguity, eliminate repetition, sharpen wording; insert [TODO: ...] in place for any missing info). Output only the polished prompt itself.`;
