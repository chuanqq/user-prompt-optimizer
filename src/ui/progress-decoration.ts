...
class ProgressBannerWidget extends WidgetType {
  ...
  toDOM(): HTMLElement {
    ...
    banner.className = "opo-progress-banner";

    const spinner = document.createElement("span");
    spinner.className = "opo-spinner";
    banner.appendChild(spinner);

    const text = document.createElement("span");
    text.className = "opo-progress-banner-text";
    text.textContent = `Optimizing… (${this.label})`;
    banner.appendChild(text);

    const stop = document.createElement("button");
    stop.className = "opo-progress-banner-stop";
