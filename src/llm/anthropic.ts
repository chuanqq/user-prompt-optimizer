...
import { buildAnthropicBody, mergeExtraBody, mergeExtraHeaders, mergeAbortSignal, createIdleTimeout } from "./params";
    ...
    try {
      ...
      for await (const data of readSSE(res)) {
        ...
        try {
          ...
          json = JSON.parse(data) as { type?: string; delta?: { type?: string; text?: string } };
        } catch {
          continue;
        }
