...
export interface PluginSettings {
  ...
  seed: number | null;
  /** Whether to prepend a role preamble (e.g. "You are a senior backend specialist...") to optimized prompts. */
  roleInjectionEnabled: boolean;
  /** Optional domain hint; when set and role injection is on, the engine uses it verbatim and always prepends. */
  roleHint: string;
}
